...
export const changeSubscriptionPlanValidation = [
  body('plan')
    .isIn(['FREE', 'PREMIUM'])
    .withMessage('Plan must be one of: FREE, PREMIUM'),
];

// Legacy validation for backward compatibility
export const updateSubscriptionValidation = changeSubscriptionPlanValidation;
